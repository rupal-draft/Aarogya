...
import com.aarogya.lab_service.dto.response.DoctorResponseDTO;
import com.aarogya.lab_service.dto.response.PatientResponseDTO;
...
public class UserGrpcClient {
    ...
    private void handleGrpcException(StatusRuntimeException e, String context) {
        ...
        switch (code) {
            case NOT_FOUND:
                throw new ResourceNotFound(description != null ? description : "Requested user not found");
            case INVALID_ARGUMENT:
                throw new BadRequestException(description != null ? description : "Invalid user request parameters");
            case PERMISSION_DENIED:
                throw new AccessForbidden(description != null ? description : "user permission denied");
            case UNAVAILABLE:
                throw new ServiceUnavailable("user service is currently unavailable");
            case FAILED_PRECONDITION:
                throw new IllegalState(description != null ? description : "Invalid user state");
            default:
                throw new ServiceUnavailable("Failed to process user request");
        }
    }
