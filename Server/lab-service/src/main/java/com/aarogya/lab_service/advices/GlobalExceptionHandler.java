...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TestOrderNotFoundException.class)
    public ResponseEntity<ApiResponse<?>> handleTestOrderNotFoundException(TestOrderNotFoundException exception) {
        logger.error("Test order not found: {}", exception.getMessage());
        ApiError apiError = new ApiError.ApiErrorBuilder()
                .setStatus(HttpStatus.NOT_FOUND)
                .setMessage(exception.getLocalizedMessage())
                .build();
    ...
    public ResponseEntity<ApiResponse<?>> handleInvalidTestException(InvalidTestException exception) {
        logger.error("Invalid test: {}", exception.getMessage());
        ApiError apiError = new ApiError.ApiErrorBuilder()
    ...
    @ExceptionHandler(SampleCollectionNotFoundException.class)
    public ResponseEntity<ApiResponse<?>> handleSampleCollectionNotFoundException(SampleCollectionNotFoundException exception) {
        logger.error("Sample collection not found: {}", exception.getMessage());
        ApiError apiError = new ApiError.ApiErrorBuilder()
                .setStatus(HttpStatus.NOT_FOUND)
                .setMessage(exception.getLocalizedMessage())
                .build();
