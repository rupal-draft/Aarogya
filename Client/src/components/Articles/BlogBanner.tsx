  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          backgroundImage: "url(https://images.pexels.com/photos/11661531/pexels-photo-11661531.jpeg)",
      ...
      >
        <motion.div className="relative">
          ...
          >
            Stay updated with the latest medical research, health tips, and healthcare innovations
          </motion.p>
