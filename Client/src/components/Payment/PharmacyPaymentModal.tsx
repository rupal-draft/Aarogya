...
export const PharmacyPaymentModal: React.FC<PharmacyPaymentModalProps> = ({
  isOpen,
  onClose,
  order,
  onPaymentSuccess,
  ...
  const handlePayment = async () => {
    try {
      ...
      const paymentRequest: InitiatePharmacyPaymentRequest = {
        orderId: order.id,
      ...
      const paymentResponse = await paymentService.initiatePharmacyPayment(
        paymentRequest
      );
        ...
        handler: async function (response: any) {
          try {
            ...
            if (verificationResult.valid) {
              await paymentService.confirmPharmacyPaymentWithoutWebhook(
                verifyRequest
              );

              const details = await paymentService.getPharmacyPaymentByOrderId(
        ...
        >
          ...
          <div className="relative bg-gradient-to-r from-emerald-600 to-teal-600 text-white p-6">
            ...
            <div className="text-center">
              ...
              <p className="text-emerald-100">Medicine Order Payment</p>
            </div>
          </div>
              ...
              {step === "initiate" && (
                ...
                >
                  ...
                  <motion.button
                    ...
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white py-4 rounded-2xl font-bold text-lg hover:from-emerald-700 hover:to-teal-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3"
                  >
                    {loading ? (
