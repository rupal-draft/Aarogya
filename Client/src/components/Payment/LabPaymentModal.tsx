...
export const LabPaymentModal: React.FC<LabPaymentModalProps> = ({
  isOpen,
  onClose,
  order,
  onPaymentSuccess,
  ...
  const handlePayment = async () => {
    try {
      ...
      const paymentRequest: InitiateLabPaymentRequest = {
        orderId: order.id,
      ...
      const paymentResponse = await paymentService.initiateLabPayment(
        paymentRequest
      );
      ...
      const options = {
        ...
        name: "Aaorgya Lab Services",
        description: `Lab Tests Order #${order.orderNumber}`,
        ...
        handler: async function (response: any) {
          try {
            ...
            if (verificationResult.valid) {
              await paymentService.confirmLabPaymentWithoutWebhook(
                verifyRequest
              );

              const details = await paymentService.getLabPaymentByOrderId(
        ...
        >
          ...
          <div className="relative bg-gradient-to-r from-cyan-600 to-blue-600 text-white p-6">
            ...
            <div className="text-center">
              ...
              <p className="text-cyan-100">Lab Tests Payment</p>
            </div>
          </div>
              ...
              {step === "initiate" && (
                ...
                >
                  ...
                  <motion.button
                    ...
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 text-white py-4 rounded-2xl font-bold text-lg hover:from-cyan-700 hover:to-blue-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3"
                  >
                    {loading ? (
              ...
              {step === "processing" && (
                ...
                >
                  <motion.div
                    ...
                    className="w-16 h-16 border-4 border-cyan-200 border-t-cyan-600 rounded-full mx-auto"
                  />
              ...
              {step === "success" && paymentDetails && (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Your lab tests have been confirmed and scheduled
                    </p>
                  </div>
