...
import type { DoctorAvailabilityResponse, DoctorResponseDTO } from "../types/doctor"
...
export const getDoctorsBySpecialization = async (specialization?: string): Promise<DoctorResponseDTO[]> => {
  try {
